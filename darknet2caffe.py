# The caffetest module needs to be on the Python path;
#  we'll add it here explicitly.
caffe_root='/home/chen/caffetest/'
#os.chdir(caffe_root)
import sys
...
if __name__ == '__main__':
    ...
    cfgfile = r'./cfg/car/best_fuse_opt5.cfg'
    #cfgfile = r'./cfg/yolov3.cfg'
    #net_info = cfg2prototxt(cfgfile)
    #print_prototxt(net_info)
    #save_prototxt(net_info, 'tmp.prototxt')
    weightfile = r'./cfg/car/best_fuse.weight'
    #weightfile = r'./cfg/yolov3.weights'

    protofile = r'./cfg/car/yolo.prototxt'
    caffemodel = r'./cfg/car/yolo.caffemodel'
