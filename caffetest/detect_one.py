...
from caffetest.utils import *
import argparse

def parse_args():
    parser = argparse.ArgumentParser('YOLOv3')

    parser.add_argument('--prototxt', type=str, default='best_fuse.prototxt')
    parser.add_argument('--caffemodel', type=str, default='best_fuse.caffemodel')
